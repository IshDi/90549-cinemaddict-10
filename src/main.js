'use strict';
// Компоненты: «Фильтры», «Show more» и «Попап» отрисовываются 1 раз
// Компонент «Карточка фильма» отрисовывается 5 раз
// Дополнительно «Карточка фильма» отрисовывается дважды в блоках «Top rated movies» и «Most commented»
const COUNT_CARDS = 5;
...
const createSectionAllFilmsTemplate = () => {
  return (
...
const createTitleTopRatedFilmsTemplate = () => {
  return (
    `<h2 class="films-list__title">Top rated</h2>`
  );
};

const createTitleMostCommentedFilmsTemplate = () => {
  return (
